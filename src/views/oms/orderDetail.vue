    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row v-if="order.status >= 2">
          ...
          <el-col :span="6" class="table-cell">{{ order.deliverySn }}</el-col>
          <el-col :span="6" class="table-cell">{{
          ...
          <el-col :span="6" class="table-cell">
            <el-popover
              ...
              content="这是一段提示！"
            >
              <span slot="reference">{{ order.promotionInfo }}</span>
            </el-popover>
          </el-col>
        </el-row>
      </div>
      ...
      <el-table
        ...
        <el-table-column label="状态" width="120" align="center" >
          <template slot-scope="scope" class="dwdw">
            <el-tag size="medium">{{ scope.row.refundStatus |RefundStatus }}</el-tag>
  ...
  export default {
    ...
    filters: {
      ...
      RefundStatus: function (value) {
        ...
        if (value == 1) return "申请退款中";
        if (value == 2) return "已退款";
        if (value == 3) return "已拒绝退款";
    },
    },
    created() {
    ...
    methods: {
      getOrderDetail(){
        this.$axios.get('/oms/order/info/'+this.$route.query.id).then(res=>{
