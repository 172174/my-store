  ...
  <div>
    <el-card shadow="never">
      <el-form :model="selectForm"  :inline="true" size="medium" class="demo-form-inline">
        ...
        <el-form-item class="demo-form-inline-item">
          <el-select v-model="selectForm.status" placeholder="请选择订单状态" clearable>
            <el-option
        ...
        <!-- <el-form-item class="demo-form-inline-item">
          <el-input placeholder="订单" clearable></el-input >
        </el-form-item> -->
    ...
    <div class="table">
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column  type="selection" width="78" align="center"> </el-table-column>
        ...
        <el-table-column prop="totalAmount" label="金额" width="160" align="center">
          <template slot-scope="scope">
            <p>￥{{ scope.row.returnAmount }}</p>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="status" label="状态" width="130" align="center">
          <template slot-scope="scope">
          <el-tag  size="medium">{{scope.row.status | Status}}</el-tag>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    //获取订单列表
    // getList(){
    //   this.$axios.get('/oms/order/getDealOrderList',{params: {
    ...
    getList(){
      ...
      this.$axios.post('/oms/order/getDealOrderList',this.selectForm).then(res=>{
        this.orderList = res.data.data.records
        this.size = res.data.data.size;
        this.current = res.data.data.current;
        this.total = res.data.data.total;
